...
window.onload = function () {
  ...
  article_a[6].addEventListener('click', function () {
    location.href = "articles/article7.html" + search;
  });
  article_a[7].addEventListener('click', function () {
    location.href = "articles/article8.html" + search;
  });
  article_a[8].addEventListener('click', function () {
    location.href = "articles/article9.html" + search;
  });
  article_a[9].addEventListener('click', function () {
    location.href = "articles/article10.html" + search;
  });
  article_a[10].addEventListener('click', function () {
    location.href = "articles/article11.html" + search;
  });
  article_a[11].addEventListener('click', function () {
    location.href = "articles/article12.html" + search;
  });
}